...
var createTaskEl = function(taskDataObj) {
    ...
    //add task id as a customa ttribute
...
var completeEditTask = function(taskName, taskType, taskId){
    ...
    //loop through tasks array to task object with new content
...
var editTask = function(taskId){
    ...
    //get wanted content from task name and type
...
//beginning of drag and drop code
...
//beginning of drag and drop event listners
pageContentEl.addEventListener("dragstart", dragTaskHandler);
pageContentEl.addEventListener("dragover", dropZoneDragHandler);
pageContentEl.addEventListener("drop", dropTaskHandler);
pageContentEl.addEventListener("dragleave", dragLeaveHandler);
//end of drag and drop event listners
